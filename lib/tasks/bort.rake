namespace :bort do
  PLUGIN_LIST = {
    ...
    :hyperactiveresource => 'git://github.com/lukegalea/hyperactiveresource.git',
    :seed_fu => 'git://github.com/mbleigh/seed-fu.git',
    :attribute_fu => 'git://github.com/giraffesoft/attribute_fu.git'
  }
